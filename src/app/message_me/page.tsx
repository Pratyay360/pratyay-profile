                        ...
                        <div>
                            {isClient ? (
                                <form id="form" className="flex flex-col space-y-5" onSubmit={(e) => Submit(e)}>
                                    ...
                                    <input type="text" name="Name" placeholder="Enter Name" required minLength={1} className="border rounded-lg py-3 px-3 mt-2 dark:bg-black border-indigo-600 dark:placeholder-white-500 dark:text-white" />
                                    <label className="font-bold text-lg dark:text-white ">Email</label>
                                    <input type="email" name="Email" id="email" placeholder="example@email.com" required className="border rounded-lg py-3 px-3 mt-2 dark:bg-black border-indigo-600 dark:placeholder-white-500 dark:text-white" />
                                    <label className="font-bold text-lg dark:text-white">Message</label>
                                    <textarea rows={5} name="Message" placeholder="Enter Your Message" required className="border rounded-lg py-3 px-3 mt-2 dark:bg-black border-indigo-600 dark:placeholder-white-500 dark:text-white" />
