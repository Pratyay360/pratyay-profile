    ...
    return (
        <>
            ...
            <SkeletonTheme baseColor="#202020" highlightColor="#444444">
                <h1 className="top-36 p-10 text-center items-center justify-center  tracking-[20px] dark:text-gray-500 lg:text-5xl font-bold text-3xl ml-3">Blogs By Pratyay Mitra Mustafi</h1>
