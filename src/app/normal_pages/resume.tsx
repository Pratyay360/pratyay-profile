...
return (
        <>
            ...
            <div className="text-center items-center justify-center top-36 backdrop-blur-30 py-20 ">
                <Link href={'https://docs.google.com/document/d/1nnV3faKcmPaUajB3ZTO8n-jtLzomG_77dhrANbKQ_UY/edit?usp=sharing' || ''}>
                <button role="button_open_resume" className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-large text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500
