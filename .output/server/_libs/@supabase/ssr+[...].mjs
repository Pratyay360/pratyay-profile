...
//#region node_modules/.vlt/~npm~iceberg-js@0.8.1/node_modules/iceberg-js/dist/index.mjs
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+storage-js@2.107.0/node_modules/@supabase/storage-js/dist/index.mjs
...
var DEFAULT_HEADERS = { "X-Client-Info": `storage-js/2.107.0` };
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+supabase-js@2.107.0/node_modules/@supabase/supabase-js/dist/index.mjs
var version = "2.107.0";
var JS_ENV = "";
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/version.js
var VERSION = "0.8.0";
//#endregion
//#region node_modules/.vlt/~npm~cookie@1.1.1/node_modules/cookie/dist/index.js
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/utils/helpers.js
function isBrowser() {
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/utils/constants.js
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/utils/base64url.js
/**
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/cookies.js
	...
	if (!isServerClient) return {
		...
		storage: {
			...
			getItem: async (key) => {
				...
				if (chunkedCookie.startsWith(BASE64_PREFIX)) decoded = stringFromBase64URL(chunkedCookie.substring(7));
				return decoded;
			},
			...
			removeItem: async (key) => {
				...
				delete removeCookieOptions.name;
				if (removeCookies.length > 0) await setAll(removeCookies.map((name) => ({
					name,
					value: "",
					options: removeCookieOptions
				})));
	...
	return {
		...
		storage: {
			...
			getItem: async (key) => {
				...
				if (!chunkedCookie) return null;
				let decoded = chunkedCookie;
				if (typeof chunkedCookie === "string" && chunkedCookie.startsWith(BASE64_PREFIX)) decoded = stringFromBase64URL(chunkedCookie.substring(7));
				return decoded;
			},
			setItem: async (key, value) => {
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/createServerClient.js
...
//#endregion
//#region node_modules/.vlt/~npm~@supabase+ssr@0.8.0/node_modules/@supabase/ssr/dist/module/index.js
if (typeof process !== "undefined" && process.env?.npm_package_name) {
	...
	].includes(packageName)) console.warn(`
╔════════════════════════════════════════════════════════════════════════════╗
